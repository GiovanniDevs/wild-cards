...
(() => {
	...
	const faces = [
		'Club_A.png','Diamond_A.png','Heart_A.png','Spade_A.png',
		'Club_K.png','Diamond_K.png','Heart_K.png','Spade_K.png',
		'Club_Q.png','Diamond_Q.png','Heart_Q.png','Spade_Q.png',
		'Club_J.png','Diamond_J.png','Heart_J.png','Spade_J.png',
		'Joker.png','Club_2.png','Diamond_2.png','Heart_2.png','Spade_2.png'
	];
		...
		cards.forEach((face, idx) => {
			...
			card.innerHTML = `
				<div class="card-inner">
					...
					<div class="card-back"><img src="${encodeURI(imagesBase + face)}" alt="card"></div>
				</div>
			`;

			// show back initially (front is the cover)
			card.querySelector('.card-front').style.backgroundImage = `url(${encodeURI(cardBack)})`;
